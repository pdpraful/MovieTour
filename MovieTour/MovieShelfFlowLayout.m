...
@interface MovieShelfFlowLayout()
{
    NSDictionary *_shelfFrames;
}

@end
@implementation MovieShelfFlowLayout
...
- (id)init
{
    ...
    [self registerClass:[MovieShelfDecorationView class]
forDecorationViewOfKind:[MovieShelfDecorationView kind]];
...
- (NSArray *)layoutAttributesForElementsInRect:(CGRect)rect
{
    ...
    [_shelfFrames enumerateKeysAndObjectsUsingBlock:^(id key, id shelfRect, BOOL *stop) {
        if (CGRectIntersectsRect([shelfRect CGRectValue], rect))
        {
            ...
            [self layoutAttributesForDecorationViewOfKind:[MovieShelfDecorationView kind]
                                              atIndexPath:key];
